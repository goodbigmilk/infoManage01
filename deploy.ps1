...
function Ensure-Docker {
    ...
    if (-not (Test-DockerRunning)) {
        ...
        if (Test-Path $dockerPath) {
            ...
            Write-Err "Docker Desktop not running. Please start Docker Desktop first."
        }
    }
...
function Start-Deploy {
    ...
    [System.IO.File]::WriteAllText((Join-Path $PSScriptRoot ".env"), $envContent, [System.Text.Encoding]::ASCII)
